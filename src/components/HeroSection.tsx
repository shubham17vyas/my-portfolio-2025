        ...
        <div className="grid md:grid-cols-5 gap-8 items-center">
          <div className="md:col-span-3">
            <div className="space-y-6">
              ...
              >
                <span className="text-sm md:text-base font-semibold text-cyberpunk-neon inline-block py-1 px-4 rounded-full border border-cyberpunk-neon/50">
                  Software Developer
                </span>
              </div>
              ...
              >
                I'm <span className="text-cyberpunk-neon">Shubham</span> Vyas
              </h1>
              ...
              >
                Passionate about algorithms, RF engineering, trading strategies, and full-stack development. 
